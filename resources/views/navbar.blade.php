    ...
    <div class="d-lg-none">
        <div class=" bg-secondary-subtle d-flex flex-column justify-content-center align-items-center py-4"
            ...
            <div class="d-flex justify-content-center align-items-center">
                ...
                <div class="mx-2">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width="25px" height="25px"
                        class="icon icon-twitter"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                        <path
            ...
            <div class="text-center lh-1 mt-2 mb-1">
                <span class="fw-medium">Calle Volcán Vesubio #5145, El Collí Urbano, 45070, Zapopan, Jalisco.</span>
            </div>
        </div>
        <div class="d-flex py-2 align-items-center" id="navbar-sm">
            <div>
                <button class="btn" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample"
                    aria-controls="offcanvasExample">
                    <svg width="25" height="25" viewBox="0 0 25 25" xmlns="http://www.w3.org/2000/svg">
                        <rect x="1" y="2" width="23" height="4" rx="2" ry="2" fill="#FF0000" />
                        <rect x="1" y="10.5" width="16" height="4" rx="2" ry="2" fill="#FF0000" />
                        <rect x="1" y="19" width="23" height="4" rx="2" ry="2" fill="#FF0000" />
                    </svg>
                </button>
            </div>
            <div class="me-5">
                <img src="{{ asset('media/logo-tg-w-sm.png') }}" class="rounded mx-auto d-block w-25 "
        ...
        <div class="offcanvas offcanvas-start overflow-auto" tabindex="-1" id="offcanvasExample"
            ...
            <div class="accordion accordion-flush" data-bs-theme="dark" id="accordionFlushExample">
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button accordion-button-disabled collapsed" type="button"
                            data-bs-toggle="collapse" data-bs-target="#flush-collapsII" aria-expanded="false"
                            aria-controls="flush-collapseOne">
                            Capacitaciónes
                        </button>
                    </h2>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button accordion-button-disabled collapsed" type="button"
                            data-bs-toggle="collapse" data-bs-target="#flush-collapseIII" aria-expanded="false"
                            aria-controls="flush-collapseOne">
                            Eventos
                        </button>
                    </h2>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button accordion-button-disabled collapsed" type="button"
                            data-bs-toggle="collapse" data-bs-target="#flush-collapseIV" aria-expanded="false"
                            aria-controls="flush-collapseOne">
                            Multimedia
                        </button>
                    </h2>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed focus-ring" type="button" data-bs-toggle="collapse"
                            data-bs-target="#flush-collapseVII" aria-expanded="false" aria-controls="flush-collapseTwo">
                            Productos
                        </button>
                    </h2>
                    <div id="flush-collapseVII" class="accordion-collapse collapse"
                        data-bs-parent="#accordionFlushExample">
                        <div class="accordion-body">
                            <ul class="list-group list-group-flush">
                ...
                <div class="d-grid gap-5 mx-5 mt-3">
                    <button class="btn btn-contact" type="button" href="www.google.com">CONTÁCTANOS</button>
                </div>
                <div class="mt-3">
                    <h6 class="text-white mx-3 text-center fw-lighter">¡NO OLVIDES SEGUIRNOS EN NUESTROS CANALES
                        OFICIALES!</h6>
                </div>
                <div class="d-flex justify-content-evenly mt-3">
                    ...
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width="25px" height="25px"
                            class="icons icon-linkedin">
                            <path
                                d="M416 32H31.9C14.3 32 0 46.5 0 64.3v383.4C0 465.5 14.3 480 31.9 480H416c17.6 0 32-14.5 32-32.3V64.3c0-17.8-14.4-32.3-32-32.3zM135.4 416H69V202.2h66.5V416zm-33.2-243c-21.3 0-38.5-17.3-38.5-38.5S80.9 96 102.2 96c21.2 0 38.5 17.3 38.5 38.5 0 21.3-17.2 38.5-38.5 38.5zm282.1 243h-66.4V312c0-24.8-.5-56.7-34.5-56.7-34.6 0-39.9 27-39.9 54.9V416h-66.4V202.2h63.7v29.2h.9c8.9-16.8 30.6-34.5 62.9-34.5 67.2 0 79.7 44.3 79.7 101.9V416z" />
                        </svg>
                    </div>
                </div>
                <div class="d-flex align-items-end justify-content-center text-center text-white mx-auto h-25 fw-medium">
                    <span>TODOS LOS DERECHOS RESERVADOS <br> GRUPOENERTEC <svg xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="bgII d-flex  justify-content-around" style="height: 100px">
            ...
            <div class="d-flex flex-column py-1">
                <ul class="list-group list-group-horizontal">
                    <a href="#" class="text-links">Empresa</a>
                    <a class="text-links">Capacitaciónes</a>
                    <a class="text-links">Eventos</a>
                    <a class="text-links">Multimedia</a>
                    <a class="text-links btn-contact sh-r rounded">CONTACTANOS</a>
                </ul>
                <div class="p-2">
                    <ul class="list-group list-group-horizontal nav">
                        <li class="nav-item dropdown">
                            <a class="btn btn-dark dropdown-toggle custom-dropdown bg-transparent border-0"
                                href="#" id="mainDropdownMenuButton" data-bs-toggle="dropdown"
                                aria-expanded="false">
                                Servicios
                            ...
                            <ul class="dropdown-menu rounded-4 border-0" aria-labelledby="mainDropdownMenuButton">
                                <div class="accordion accordion-flush" data-bs-theme="dark"
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header">
                                            <button class="accordion-button collapsed no-icon" type="button"
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header">
                                            <button class="accordion-button collapsed no-icon" type="button"
                                                data-bs-toggle="collapse" data-bs-target="#flush-collapseFives"
                                                aria-expanded="false" aria-controls="flush-collapseThree">
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header">
                                            <button class="accordion-button collapsed no-icon" type="button"
                                                data-bs-toggle="collapse" data-bs-target="#flush-collapseSixs"
                                                aria-expanded="false" aria-controls="flush-collapseThree">
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header">
                                            <button class="accordion-button collapsed no-icon" type="button"
                                                data-bs-toggle="collapse" data-bs-target="#flush-collapseSevens"
                                                aria-expanded="false" aria-controls="flush-collapseThree">
                        ...
                        {{-- <li class="nav-item dropdown btn btn-dark dropdown-toggle custom-dropdown bg-transparent border-0"
                            data-bs-toggle="dropdown" aria-expanded="false">
                            Servicios
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                                class="dropdown-icon"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                                <path
                                    d="M233.4 406.6c12.5 12.5 32.8 12.5 45.3 0l192-192c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L256 338.7 86.6 169.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l192 192z" />
                            </svg>
                        </li>
                            <ul class="dropdown-menu list-group-flush rounded-3" data-bs-theme="dark">
                                <li class="bg-li nav-item">Levantamientos</li>
                                <hr class="dropdown-divider mx-3">
                                <li class="bg-li">Diseño de Proyectos</li>
                                <li>
                                    <hr class="dropdown-divider mx-3">
                                </li>
                                <li class="bg-li">Calculos de Proyectos</li>
                                <li>
                                    <hr class="dropdown-divider mx-3">
                                </li>
                                <li class="bg-li">Toma de Mediciones de entrega de obra</li>
                                <li>
                                    <hr class="dropdown-divider mx-3">
                                </li>
                                <li class="bg-li">Estudios de Resisitividad de Terreno</li>
                                <li>
                                    <hr class="dropdown-divider mx-3">
                                </li>
                                <li class="bg-li">Análisis de Puntos de Riesgo en Instalaciones E.</li>
                                <li>
                                    <hr class="dropdown-divider mx-3">
                                </li>
                                <li class="bg-li">Elaboracion Proyectos de Ahorro de Energia</li>
                                <li>
                                    <hr class="dropdown-divider mx-3">
                                </li>
                                <li class="bg-li">Estudios de Calidad de Energia</li>
                            </ul> --}}
                                    ...
                                    <div class="accordion accordion-flush" data-bs-theme="dark"
                                            ...
                                            <div id="flush-collapseOne" class="accordion-collapse collapse"
                                                ...
                                                <div class="accordion-body">
                                                    <ul class="list-group list-group-flush list-unstyled">
                                                        ...
                                                        <li class="bg-li">Sistemas de Pararayos</li>
                                                        <li>
                                                            <hr class="dropdown-divider mx-1 hr-d">
                                                        </li>
                                                        <li class="bg-li">Supresores de Picos Transitorios</li>
                                                        <li>
                                                            <hr class="dropdown-divider mx-1 hr-d">
                                                        </li>
                                                    </ul>
                                        ...
                                        <div class="accordion-item">
                                            ...
                                            <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                                ...
                                                <div class="accordion-body">
                                                    <ul class="list-group list-group-flush list-unstyled">
                                                        <li class="bg-li">Total View</li>
                                                        <li>
                                                            <hr class="dropdown-divider mx-1 hr-d">
                                                        </li>
                                                        <li class="bg-li">Total Monitor</li>
                                                        <li>
                                                            <hr class="dropdown-divider mx-1 hr-d">
                                                        </li>
                                                        <li class="bg-li">Smart View GSM</li>
                                                        <li>
                                                            <hr class="dropdown-divider mx-1 hr-d">
                                                        </li>
                                                        <li class="bg-li">Smart View Ethernet</li>
                                                        <li>
                                                            <hr class="dropdown-divider mx-1 hr-d">
                                                        </li>
                                                    </ul>
                                        ...
                                        <div class="accordion-item">
                                            ...
                                            <div id="flush-collapseThree" class="accordion-collapse collapse"
                                                ...
                                                <div class="accordion-body">
                                                    <ul class="list-group list-group-flush list-unstyled">
                                                        <li class="bg-li">UPS</li>
                                                        <li>
                                                            <hr class="dropdown-divider mx-1 hr-d">
                                                        </li>
                                                        <li class="bg-li">Reguladores</li>
                                                        <li>
                                                            <hr class="dropdown-divider mx-1 hr-d">
                                                        </li>
                                                    </ul>
                                        ...
                                        <div class="accordion-item">
                                            ...
                                            <div id="flush-collapseFive" class="accordion-collapse collapse"
                                                ...
                                                <div class="accordion-body">
                                                    <ul class="list-group list-group-flush list-unstyled">
                                                        <li class="bg-li">Shelters</li>
                                                        <li>
                                                            <hr class="dropdown-divider mx-1 hr-d">
                                                        </li>
                                                        <li class="bg-li">Torres Arriostradas</li>
                                                        <li>
                                                            <hr class="dropdown-divider mx-1 hr-d">
                                                        </li>
                                                    </ul>
                                        ...
                                        <div class="accordion-item">
                                            ...
                                            <div id="flush-collapseSeven" class="accordion-collapse collapse"
                                                ...
                                                <div class="accordion-body">
                                                    <ul class="list-group list-group-flush list-unstyled">
                                                        <li class="bg-li">Banco de Capacitores</li>
                                                        <li>
                                                            <hr class="dropdown-divider mx-1 hr-d">
                                                        </li>
                                                        <li class="bg-li">Banco de Capacitores Fijo</li>
                                                        <li>
                                                            <hr class="dropdown-divider mx-1 hr-d">
                                                        </li>
                                                    </ul>
                        ...
                        <li class="text-links">Manuales</li>
                    </ul>
                </div>
            </div>
        </div>
