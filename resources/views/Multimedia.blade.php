    ...
    <div class="row p-2">
        ...
        <div class="col-md-3 ">
            <div class="d-flex flex-column mb-2">
                <div class="row">
                    <h3 class="fw-bold fs-3 ">Categorias</h3>
                    <div class="col-12 mb-3">
                        <div class="custom-card"
                            style="background-image: url('{{ asset('media/Proteccion.webp') }}');">
                        </div>
                    </div>
                    <div class="col-12 mb-3">
                        <div class="custom-card"
                            style="background-image: url('{{ asset('media/Regulacion y respaldo.webp') }}');">
                        </div>
                    </div>
                    <div class="col-12 mb-3">
                        <div class="custom-card"
                            style="background-image: url('{{ asset('media/Telemetria y control.webp') }}');">
                        </div>
                    </div>
