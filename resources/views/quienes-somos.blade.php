    ...
    <div class="container bg-transparent">
        <div class="row">
                ...
                <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item active">
                            <img class="" src="{{ asset('media/banners_productos/BANNERTemporadadelluvias.webp') }}" alt="Banner TGOne" />
                        ...
                        <div class="carousel-item">
                            <img src="{{ asset('media/services_img/banner_Empresa_2400x1000px.jpg') }}" alt="Banner Empresa" />
                            <div class="carousel-caption d-none d-md-block">
                            </div>
                        </div>
                        ...
                        <!-- Cuarta imagen -->
                        <div class="carousel-item">
                            <img class="" src="{{ asset('media/banners_productos/Proteccion.webp') }}" alt="Banner TGOne" />
                            <div class="carousel-caption d-none d-md-block">
                            </div>
                        </div>
            ...
            <div class="row px-3 grid bg-items-menu">
                <div class="col-12">
                    <h1 class="fw-bolder fs-1 my-2 text-center text-dark">Divisiones Total Ground</h1>
                    <p class="fw-light fs-6 text-center text-dark">Elige la división de Total Ground que más convenga para
                        tu proyecto.</p>
            ...
            <div class="row px-5 py-5 custom-grid bg-items-menu-rows">
            ...
            <div class="row px-5 py-3 d-flex justify-content-center bg-items-menu-rows">
