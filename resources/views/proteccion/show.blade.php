...
<div class="container">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="text-start text-dark fw-semibold">{{ $producto->nombre_kit }}</h1>

            <!-- Breadcrumb -->
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item d-flex"><a href="{{ route('categorias.index') }}">Productos</a></li>
                    <li class="breadcrumb-item d-flex"><a href="{{ route('proteccion.index', ['categoria_slug' => $categoria->slug]) }}">{{ $categoriaSinSlug }}</a></li>
                    <li class="breadcrumb-item d-flex"><a href="{{ route('proteccion.subcategoria', ['categoria_slug' => $categoria->slug, 'subcategoria_slug' => $producto->subcategoria->slug]) }}">{{ $producto->subcategoria->nombre_subcategoria }}</a></li>
                    <li class="breadcrumb-item active d-flex" aria-current="page">{{ $producto->nombre_kit }}</li>
                </ol>
            </nav>
            <!-- Fin del Breadcrumb -->
