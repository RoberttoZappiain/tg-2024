@extends('welcome')
@section('title', 'Servicios - Total Ground')

@section('content')
<div class="container" style="margin-top: 130px">
    <div class="row">
        <div class="col-12">
            <h1 class="text-dark fs-1 fw-semibold my-3">SERVICIOS TOTALGROUND</h1>
            <p class="fs-normal fs-5">Con más de 20 años en el mercado, nuestra filosofía es ofrecer valores agregados a nuestros clientes no solamente con productos y soluciones, sino dándoles una amplia gama de servicios que sean un respaldo directo de la marca.</p>
        </div>
        <div class="col-12 col-lg-3 mt-3 bg-secondary-subtle rounded-3">
            <div class="list-group custom-list-group gap-1 mt-3" id="list-tab" role="tablist">
                <a class="list-group-item custom-list-group-item rounded-3 {{ request('tab') == 'list-lev' || is_null(request('tab')) ? 'active' : '' }}"
                    id="list-lev-list" data-bs-toggle="list" href="#list-lev" role="tab" aria-controls="list-lev">
                    <i class="fa-solid fa-map-location-dot"></i>Acompañamiento en Levantamientos
                </a>
                <a class="list-group-item custom-list-group-item rounded-3" id="list-proyect-list" data-bs-toggle="list"
                    href="#list-proyect" role="tab" aria-controls="list-proyect"><i
                        class="fa-solid fa-compass-drafting"></i>Diseño
                    de Proyectos</a>
                <a class="list-group-item custom-list-group-item rounded-3" id="list-calcu-list" data-bs-toggle="list"
                    href="#list-calcu" role="tab" aria-controls="list-calcu"><i
                        class="fa-solid fa-square-root-variable"></i>Elaboración de justificación técnicas y cálculos de
                    proyectos</a>
                <a class="list-group-item custom-list-group-item rounded-3" id="list-medicion-list"
                    data-bs-toggle="list" href="#list-medicion" role="tab" aria-controls="list-medicion"><i
                        class="fa-solid fa-ruler-combined"></i>Toma de
                ...
                <a class="list-group-item custom-list-group-item rounded-3" id="list-resis-list" data-bs-toggle="list"
                    href="#list-resis" role="tab" aria-controls="list-resis"><i
                        class="fa-solid fa-earth-americas"></i>Estudios de
                    Resistividad de Terreno</a>
                <a class="list-group-item custom-list-group-item rounded-3" id="list-inst-list" data-bs-toggle="list"
                    href="#list-inst" role="tab" aria-controls="list-inst"><i
                        class="fa-solid fa-circle-exclamation"></i></i>Análisis
                ...
                <a class="list-group-item custom-list-group-item rounded-3" id="list-energy-list" data-bs-toggle="list"
                    href="#list-energy" role="tab" aria-controls="list-energy"><i
                        class="fa-solid fa-solar-panel"></i>Elaboración de Proyectos de Ahorro de Energía</a>
                <a class="list-group-item custom-list-group-item rounded-3" id="list-ec-list" data-bs-toggle="list"
                    href="#list-ec" role="tab" aria-controls="list-ec"><i class="fa-solid fa-bolt"></i>Estudios de
                    Calidad de Energía</a>
            </div>
        </div>
        <div class="col-12 col-lg-9 mt-3 bg-secondary-subtle p-3">
