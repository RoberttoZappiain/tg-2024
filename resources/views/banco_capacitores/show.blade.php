        ...
        <div class="col-lg-12">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item d-flex">
                        <a href="{{ route('general.index', ['table' => 'banco_capacitores']) }}">Banco de Capacitores</a>
                    </li>

                    <!-- Mostrar el nombre del kit actual según el slug -->
                    <li class="breadcrumb-item active" aria-current="page">
                        @if ($producto->slug == 'banco-de-capacitores')
                            Banco de Capacitores
                        @elseif ($producto->slug == 'banco-de-capacitores-fijo')
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-4">
                    <figure class="figure">
                        ...
                        <figcaption class="figure-caption text-end"> <span
                                class="text-uppercase">{{ $producto->categoria }}</span> <br> Medidas del empaque:
                ...
                <div class="col-12 col-lg-6 text-white rounded-3">
                    <table id="table_details"
                        ...
                        <caption class="text-center">Descripcion general del producto {{ $producto->categoria }}. Para más informacion,
