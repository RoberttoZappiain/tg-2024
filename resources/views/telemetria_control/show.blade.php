...
@section('content')
@php
    $categoriaSinSlug = str_replace('-', ' ', $producto->categoria);
@endphp
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item d-flex"><a href="">Productos</a></li> <!-- Ruta a Productos generales -->
            <li class="breadcrumb-item d-flex"><a href="{{ route('general.show', ['table' => 'telemetria_control', 'slug' => $producto->slug]) }}">Telemetria y Control</a></li> <!-- Telemetria y Control -->
            <li class="breadcrumb-item d-flex"><a href="#">{{ $producto->categoria }}</a></li> <!-- Nombre de la categoría dinámica -->
            <li class="breadcrumb-item d-flex active" aria-current="page">{{ $producto->nombre_kit }}</li> <!-- Producto actual -->
        </ol>
    </nav>
    ...
    <div class="row">
        ...
        <div class="col-12 col-lg-4">
            <figure class="figure">
                <img src="{{ asset($producto->url_img_1) }}" class="figure-img img-fluid rounded p-5 zoom-img"
                    alt="...">
                <figcaption class="figure-caption text-end"> <span
                        class="text-uppercase">{{ $categoriaSinSlug }}</span> <br> Medidas del empaque:
                    {{ $producto->MEDIDA_EMPAQUE }}.
                </figcaption>
            </figure>
        </div>
        <div class="col-12 col-lg-6 text-white rounded-3">
            <table id="table_details"
                ...
                <caption class="text-center">Descripcion general del producto {{ $categoriaSinSlug }}. Para más informacion,
                ...
                <tbody>
                    <tr>
                        <td class="fw-regular"><strong class="fw-bolder text-center">Nombre del
                                kit:</strong></td>
                        <td class="text-uppercase">{{ $producto->nombre_kit }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>{{ $producto->PESO_PZA_5u }}</td>
                    </tr>
                    <tr>
                        <td><strong class="fw-bolder">Peso con empaque:</strong></td>
                        <td>{{ $producto->PESO_CON_EMPAQUE_5u }}</td>
                    </tr>
                </tbody>
            </table>
                    ...
                    <div class="accordion-item">
                        <div id="flush-collapseOne" class="accordion-collapse"
                            ...
                            <div class="accordion-body">
                                <div class="flip-book-container" src="{{ $producto->url_ficha_tecn }}">
                ...
                <div class="accordion accordion-flush" id="accordionFlushExample">
                    <div class="accordion-item">
                        <div id="flush-collapseOne" class="accordion-collapse"
                            ...
                            <div class="accordion-body">
                                <div id="pdf-container">
                                    <object data="{{ $producto->url_manual_pdf }}" type="application/pdf"
                                        width="100%" height="100%">
                                        <p>Tu navegador no soporta PDFs. Descarga el PDF para verlo: <a
                                                href="{{ $producto->url_manual_pdf }}">Descargar PDF</a>.</p>
                                    </object>
                                </div>
...
loader.load("{{ $producto->url_model_3d }}", function(object) {
